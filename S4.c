...
void replace_path(const char *input, char *output, size_t outsize) {
    ...
    const char *replacement1 = "~S4/";
    const char *replacement2 = "S4/";
    const char *replacement3 = "~S4";
    const char *replacement4 = "S4";
...
void uploadf(int socket){
    ...
    char path[512];
    snprintf(path, sizeof(path), "%s/%s", temp, filename); //full pat
